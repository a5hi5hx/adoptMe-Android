...
class HomeBirds extends StatefulWidget {
  const HomeBirds({super.key});

  @override
  State<HomeBirds> createState() => _HomeBirdsState();
}

class _HomeBirdsState extends State<HomeBirds> {
  late List<Pet> pets = [];
