...
class HomeOthers extends StatefulWidget {
  const HomeOthers({super.key});

  @override
  State<HomeOthers> createState() => _HomeOthersState();
}

class _HomeOthersState extends State<HomeOthers> {
  late List<Pet> pets = [];
